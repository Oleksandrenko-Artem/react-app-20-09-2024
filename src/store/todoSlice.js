...
export const loadTasks = createAsyncThunk('todo/loadTasks',
    async () => {
...
export const { addNewTask, toogleTaskIsDone, deleteTask } = todoSlice.actions;
